...
{
    public sealed class LevelContentMapper
    {
        public LevelDefinition Map(LevelContentDto content)
        {
            if (content == null)
            {
            ...
            LevelDto levelDto = content.Level;
        ...
        private static IReadOnlyList<GrillMovementGroupDefinition> MapMovementGroups(
