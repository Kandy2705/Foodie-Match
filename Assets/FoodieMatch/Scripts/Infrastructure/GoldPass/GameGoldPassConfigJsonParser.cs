...
{
    public sealed class GameGoldPassConfigJsonParser
    {
        ...
        private static IReadOnlyList<GoldPassRewardDefinition>
            MapTreasureContents(GoldPassRewardDto[] contents)
        {
            if (contents == null)
            {
